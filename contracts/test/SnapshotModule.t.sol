...
contract SnapshotModuleTest__Stake is SnapshotModule__initialized {
    function testStake() public {
        SnapshotModule(address(c)).stake(1e18);
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 1e18);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(this));
        assertEq(SnapshotModule(address(c)).totalSupply(), 1e18);
    }

    function testStake__AmountZero() public {
        vm.expectRevert();
        SnapshotModule(address(c)).stake(0);
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 0);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(0));
        assertEq(SnapshotModule(address(c)).totalSupply(), 0);
    }
    ...
    function testStake__AndStakeWithDelegate() public {
        SnapshotModule(address(c)).stake(1e18);
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 1e18);
        assertEq(SnapshotModule(address(c)).voteOf(address(this)), 1e18);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(this));

        SnapshotModule(address(c)).stakeWithDelegate(1e18, address(1234));
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 2e18);
        assertEq(SnapshotModule(address(c)).balanceOf(address(1234)), 0);
        assertEq(SnapshotModule(address(c)).voteOf(address(this)), 0);
        assertEq(SnapshotModule(address(c)).voteOf(address(1234)), 2e18);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(1234));
        assertEq(SnapshotModule(address(c)).totalSupply(), 2e18);
    }
    ...
    function testStakeWithDelegate() public {
        ...
        assertEq(SnapshotModule(address(c)).balanceOf(address(1234)), 0);
        assertEq(SnapshotModule(address(c)).voteOf(address(this)), 0);
        assertEq(SnapshotModule(address(c)).voteOf(address(1234)), 1e18);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(1234));
        assertEq(SnapshotModule(address(c)).totalSupply(), 1e18);
    }
...
contract SnapshotModuleTest__StakedSelf is SnapshotModule__initialized {
    ...
    function testUnstake__LessAmount() public {
        ...
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 5e17);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(this));
        assertEq(SnapshotModule(address(c)).totalSupply(), 25e17);
    ...
    function testUnstake__OverAmount() public {
        ...
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 1e18);
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(this));
        assertEq(SnapshotModule(address(c)).totalSupply(), 3e18);
    ...
    function testDelegate() public {
        ...
        assertEq(SnapshotModule(address(c)).getDelegate(address(this)), address(1234));
        assertEq(SnapshotModule(address(c)).balanceOf(address(this)), 1e18);
        assertEq(SnapshotModule(address(c)).balanceOf(address(1234)), 1e18);
        assertEq(SnapshotModule(address(c)).voteOf(address(this)), 0);
        assertEq(SnapshotModule(address(c)).voteOf(address(1234)), 2e18);
        assertEq(SnapshotModule(address(c)).totalSupply(), 3e18);
    }
    ...
    function testDelegate__NotStaked() public {
        ...
        assertEq(SnapshotModule(address(c)).balanceOf(address(0xa)), 0);
        assertEq(SnapshotModule(address(c)).balanceOf(address(1234)), 1e18);
        assertEq(SnapshotModule(address(c)).totalSupply(), 3e18);
    }
}

contract SnapshotModuleTest__StakedToDelegatee is SnapshotModule__initialized {
    function setUp() public override {
        super.setUp();
    ...
    function testUnstake__FullAmount() public {
        ...
        // past
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number - 3), 1e18);
        // now
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number), 0);
    ...
    function testUnstake__LessAmount() public {
        ...
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number - 3), 1e18);
        // now
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number), 5e17);
    ...
    function testUnstake__OverAmount() public {
        ...
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number - 3), 1e18);
        // now
        assertEq(SnapshotModule(address(c)).getPriorVotes(address(0xa), block.number), 1e18);
